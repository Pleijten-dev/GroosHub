/**
 * Community Spaces Recommendations Page
 * Displays AI-generated communal space recommendations grouped by category
 */
...
export default function CommunityPage() {
  ...
  const totalM2 = currentScenario.communal_spaces.total_m2;
