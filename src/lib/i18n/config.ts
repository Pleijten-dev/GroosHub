  ...
  const translations = {
    nl: {
      ...
      changePassword: {
        ...
        passwordHint: 'Minimaal 8 tekens, met een hoofdletter, kleine letter en cijfer.',
        ...
        passwordRequirements: 'Wachtwoord moet een hoofdletter, kleine letter en cijfer bevatten',
        error: 'Er is een fout opgetreden. Probeer het opnieuw.',
      },
      admin: {
        title: 'Administratie',
    ...
    en: {
      ...
      changePassword: {
        ...
        passwordHint: 'At least 8 characters, with an uppercase letter, lowercase letter, and number.',
        ...
        passwordRequirements: 'Password must contain an uppercase letter, lowercase letter, and number',
        error: 'An error occurred. Please try again.',
      },
      admin: {
